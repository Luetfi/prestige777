    ...
    <div className="contact-page">
      ...
      <section className="contact-content">
        ...
        <div className="container">
          ...
          <div className="social-links scroll-reveal reveal-fade-up">
            <h3>Folge uns</h3>
            <div className="social-icons">
              ...
              <a href="https://www.facebook.com/prestige77Remseck/" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="social-btn">
                <svg viewBox="0 0 24 24" fill="currentColor">
